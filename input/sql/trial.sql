...
CREATE TABLE IF NOT EXISTS rating (
  rating INTEGER NOT NULL AUTO_INCREMENT UNIQUE,
  movie_language VARCHAR(25) NOT NULL UNIQUE,
...
LOAD DATA LOCAL INFILE './output/movies/zfp-movie_genres-split.csv'
INTO TABLE genre
  CHARACTER SET utf8mb4
  FIELDS TERMINATED BY '\t'
  ENCLOSED BY '"'
...
--
CREATE TEMPORARY TABLE movie_actor_1
  (
    movie_id INTEGER NOT NULL AUTO_INCREMENT UNIQUE,
...
CREATE TEMPORARY TABLE movie_actor_2
  (
    movie_id INTEGER NOT NULL AUTO_INCREMENT UNIQUE,
    actor_id INTEGER NOT NULL,
    actor_name VARCHAR(255) NOT NULL,
...
CREATE TEMPORARY TABLE movie_actor_3
  (
    movie_id INTEGER NOT NULL AUTO_INCREMENT UNIQUE,
    actor_id INTEGER NOT NULL,
    actor_name VARCHAR(255) NOT NULL,
...
-- INSERT IGNORE INTO actor (actor_name)
...
--
4.0 Create movie_keyword M2M
  1. temp_movie_keyword 
  2. join movie and keyword 
  3.
